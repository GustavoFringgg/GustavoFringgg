...
<p align="center">
  <img 
    src="https://raw.githubusercontent.com/GustavoFringgg/GustavoFringgg/output/github-contribution-grid-snake-dark.svg" 
    alt="github snake" 
</p>

**Full-Stack Software Engineer** with **1 year of core development experience**.<br>
**Frontend Stack:** Vue 3、Nuxt、TypeScript、Tailwind CSS<br>
**Backend Stack:** Node.js (Express)、Python (FastAPI)、 C# (ASP.NET Core)、 RESTful APIs<br>
**Security & Architecture:** Google Cybersecurity Certificate holder, passionate about secure software development and modern system architecture.
...
[![My Skills](https://skillicons.dev/icons?i=nodejs,express,py,fastapi,cs)](https://skillicons.dev)<br>
